...
Person.create(name: "Larry", occupation: "Lumberjack")
...
Wound.create(name: "severed thumb", description: "when you accidentally cut your thumb off", img_url: "https://s3.studylib.net/store/data/007203711_1-0477a3e4ca2e9f71a512e22c990b997f.png", person_id: 3)